...
class FInvoice_Save_Action extends Vtiger_Save_Action
{
	/**
	...
	public function process(\App\Request $request)
	{
		...
		if($request->getInteger('generateReglement'))
		{
			$loadUrl="index.php?module=Reglements&view=Edit&reference_id=".$recordModel->getId();
		}
